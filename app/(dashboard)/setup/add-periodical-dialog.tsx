...
type AddPeriodicalDialogProps = {
  isOpen: boolean;
  onClose: () => void;
  onAddPeriodical: (name: string, url?: string | null, cityId?: number | null) => Promise<void>;
  initialName?: string;
  cities: CityWithRelations[];
};

function AddPeriodicalDialog({ isOpen, onClose, onAddPeriodical, initialName, cities }: AddPeriodicalDialogProps) {
